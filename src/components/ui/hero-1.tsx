  ...
  return (
    ...
    >
      ...
      <div
        ...
        dark:bg-[linear-gradient(to_right,#18181b_1px,transparent_1px),linear-gradient(to_bottom,#18181b_1px,transparent_1px)]
        bg-[size:6rem_5rem] 
      ...
      <div
        ...
        -translate-x-1/2 rounded-[100%] border border-border bg-white dark:bg-black 
      ...
      {eyebrow && (
        <a href="#" className="group inline-block mb-4">
          <span
            ...
            border border-gray-300/20 dark:border-white/5 
