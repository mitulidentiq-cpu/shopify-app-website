...
export function AppShowcase() {
  return (
    <section id="app-showcase" className="w-full bg-white py-20 md:py-28 border-t border-zinc-100">
      <div className="container mx-auto max-w-6xl px-6 md:px-8">

        {/* Section Header */}
        <div className="flex flex-col items-center text-center gap-4 mb-16">
          <span className="inline-flex px-4 py-1 rounded-full border border-zinc-200 text-zinc-500 text-xs uppercase tracking-widest font-semibold">
            App Feature
          </span>
          <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-zinc-900 max-w-2xl leading-tight">
            Meet{" "}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-zinc-600 text-sm font-semibold ml-1">5.0</span>
              <span className="text-zinc-400 text-sm">(New App — Be First!)</span>
            </div>
            ...
            <ul className="flex flex-col gap-3">
              {features.map((feat, i) => (
                ...
                >
                  <span className="mt-0.5 flex items-center justify-center w-5 h-5 rounded-full bg-zinc-900 text-white text-[10px] font-bold shrink-0">
                    ✓
                  </span>
                  {feat}
                </motion.li>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mt-2 font-bold text-sm text-zinc-900 border-b-2 border-zinc-900 pb-0.5 w-fit hover:text-zinc-500 hover:border-zinc-500 transition-colors group"
            >
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 rounded-3xl blur-2xl opacity-80" />
