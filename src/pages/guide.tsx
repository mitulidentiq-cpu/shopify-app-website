          ...
          <FadeUp delay={0.25}>
            <div className="mt-8">
              <a
                ...
                className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-xl bg-zinc-900/60 border border-zinc-800 hover:bg-zinc-900 text-zinc-300 text-xs uppercase tracking-wider font-extrabold transition-all duration-200 hover:scale-102 hover:border-zinc-700 cursor-pointer shadow-md"
              >
          ...
          <div className="flex border-b border-zinc-800 gap-8 mb-12">
            <button
              ...
              className={`pb-4 text-sm font-bold uppercase tracking-wider cursor-pointer relative transition-colors ${
                activeTab === "hub" ? "text-white font-black" : "text-zinc-500 hover:text-zinc-300"
              }`}
            >
              ...
              {activeTab === "hub" && (
                <motion.div layoutId="guideActiveTab" className="absolute bottom-0 left-0 right-0 h-[2px] bg-white" />
              )}
            </button>
            ...
            <button
              ...
              className={`pb-4 text-sm font-bold uppercase tracking-wider cursor-pointer relative transition-colors ${
                activeTab === "variants" ? "text-white font-black" : "text-zinc-500 hover:text-zinc-300"
              }`}
            >
              <span className="flex items-center gap-2">
            ...
            <button
              ...
              className={`pb-4 text-sm font-bold uppercase tracking-wider cursor-pointer relative transition-colors ${
                activeTab === "general" ? "text-white font-black" : "text-zinc-500 hover:text-zinc-300"
              }`}
            >
              <span className="flex items-center gap-2">
              ...
              <div className="flex-1 flex items-center justify-center p-6 relative">
                <AnimatePresence mode="wait">
                  ...
                  {activeTab === "hub" && activeStep === 1 && (
                    ...
                    >
                      <div className="flex items-center justify-between border-b border-zinc-800/80 pb-3 mb-4">
                        ...
                        <div className="w-8 h-4 rounded-full bg-zinc-800 relative p-0.5 flex justify-end">
                      ...
                      <div className="bg-zinc-900 border border-zinc-800 px-3.5 py-2.5 rounded-xl flex items-center gap-2 text-[10px] text-zinc-300 font-bold uppercase tracking-wider">
                  ...
                  {activeTab === "hub" && activeStep === 2 && (
                    ...
                    >
                      {[
                        { title: "FAQ Accordion", icon: HelpCircle, color: "from-zinc-700 to-zinc-800" },
                        { title: "Instagram Reels", icon: Monitor, color: "from-zinc-700 to-zinc-800" },
                        { title: "Quantity Bundles", icon: Sparkles, color: "from-zinc-700 to-zinc-800" },
                        { title: "Image Carousel", icon: Layers, color: "from-zinc-700 to-zinc-800" },
                      ].map((item, i) => (
                        <div key={i} className="bg-zinc-950/70 border border-zinc-850 p-4 rounded-xl flex flex-col justify-between group hover:border-zinc-700 transition-colors">
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex justify-between items-center bg-zinc-900/60 p-3 rounded-lg border border-zinc-800/80">
                          ...
                          <div className="w-4 h-4 rounded bg-zinc-800 border border-white/20" />
                        </div>
                      </div>
                    </motion.div>
                  )}
                  ...
                  {activeTab === "variants" && activeStep === 1 && (
                    ...
                    >
                      ...
                      <div className="bg-zinc-900 border border-zinc-800 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-wider text-zinc-350">
                    ...
                    >
                      <div className="bg-zinc-950/70 border border-zinc-850 p-5 rounded-2xl flex flex-col gap-3">
                        ...
                        <div className="flex gap-2">
                          <div className="w-8 h-8 rounded-full bg-zinc-850 border-2 border-white ring-2 ring-zinc-800" />
                      ...
                      <div className="bg-zinc-950/70 border border-zinc-850 p-5 rounded-2xl flex flex-col gap-3">
                        ...
                        <div className="flex gap-2 text-[10px] font-bold">
                          <span className="px-3 py-1.5 rounded-lg border border-zinc-800 bg-zinc-900/60 text-zinc-200">S</span>
                  ...
                  {activeTab === "variants" && activeStep === 3 && (
                    <motion.div
                      ...
                      className="w-full max-w-sm bg-zinc-950/70 border border-zinc-850 p-6 rounded-2xl flex flex-col gap-4 text-center"
                    >
                      <div className="w-12 h-12 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center mx-auto text-zinc-200 font-bold">
                        ✓
                      </div>
                      <div>
                  ...
                  {activeTab === "general" && activeStep === 1 && (
                    ...
                    >
                      <div className="flex justify-between items-center border-b border-zinc-800 pb-3">
                        ...
                        <span className="text-[9px] uppercase font-bold text-zinc-200 bg-zinc-900 border border-zinc-800 px-2 py-0.5 rounded">Connected</span>
                      </div>
                  ...
                  {activeTab === "general" && activeStep === 3 && (
                    <motion.div
                      ...
                      className="w-full max-w-sm bg-zinc-950/70 border border-zinc-850 p-6 rounded-2xl flex flex-col gap-4 text-center"
                    >
                      <div className="text-4xl font-black text-white">99 // A+</div>
                      <div>
        ...
        <FadeUp delay={0.4}>
          <div className="mt-28 border-t border-zinc-800/80 pt-20">
            <div className="max-w-3xl mb-12">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-zinc-800 bg-zinc-900/60 text-zinc-300 text-[10px] uppercase tracking-widest font-bold mb-4">
                ...
                >
                  ...
                  <div className="relative aspect-video rounded-xl overflow-hidden bg-zinc-950 border border-zinc-850">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-12 h-12 rounded-full bg-zinc-900/90 flex items-center justify-center border border-zinc-800 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  ...
                  {/* Title & Desc */}
                  <h3 className="text-white font-bold text-sm mt-4 group-hover:text-white transition-colors line-clamp-1">
                    {video.title}
                  </h3>
